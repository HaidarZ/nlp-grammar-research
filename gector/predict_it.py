...
def predict_for_text(input_text, model, batch_size=32, to_normalize=False):
    test_data = input_text.strip().split('\n')
    predictions = []
    cnt_corrections = 0
    batch = []
...
def main(args):
    ...
    while True:
        ...
        corrected_text, cnt_corrections = predict_for_text(input_text, model,
